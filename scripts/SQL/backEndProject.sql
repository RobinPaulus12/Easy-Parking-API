...
INSERT INTO manager (name, username, password)
VALUES ('Hirwa', 'Bienvenu', '$argon2id$v=19$m=65536,t=3,p=4$wYFFJf4nQfu8VZPR4Ba4lw$frNp7N+EnhjUBvQpXEsysU9gg7CtTH8Rq/v8xqm32cs'); --password
...
INSERT INTO "user" (name, firstname, date_of_birth, username, password, avatar)
